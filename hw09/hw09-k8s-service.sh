...
NAMESPACE="hw09"
CHART_DIR="k8s/charts/hw09-k8s-service"

function usage {
    echo "Usage: hw09-k8s-service {start|stop|installDB|dropDB|test}"
    exit 1
}
...
function portForward {
    ...
    kubectl port-forward service/prod-hw09-k8s-service 8001:8000 --namespace $NAMESPACE &
