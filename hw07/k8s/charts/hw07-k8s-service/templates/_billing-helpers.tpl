...
{{- printf "%s-billing" .Chart.Name | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- else }}
{{- printf "%s-%s-billing" .Release.Name $name | trunc 63 | trimSuffix "-" }}
{{- end }}
{{- end }}
{{- end }}
...
{{- printf "%s-%s-billing" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" }}
{{- end }}
